...
export default function HomeCard() {
  return (
    <>
      <div className="sm:w-1/2 bg-pink-50 mt-20 border border-4 border-pink-400 flex justify-center flex-wrap p-4 w-10/12 rounded m-auto">
        <div className="p-1 w-full border border-2 border-pink-300 bg-white rounded">
          <p>www.julie.codes</p>
        </div>
        <div className="sm:w-full border border-4 border-pink-300 flex justify-center flex-wrap p-4 w-10/12 rounded m-auto">
          <Nav />
          <div className="sm:w-1/2 flex justify-center pt-8">
            <img
              src="/images/pfp.jpg"
              alt=""
          ...
          <div className="flex flex-col align-center p-8 justify-center">
